...
This message was sent from your portfolio contact form.
      ...
      // Create mailto link
      const mailtoLink = `mailto:amarpandey4646@gmail.com?subject=${encodeURIComponent(`Portfolio Contact: ${formData.subject}`)}&body=${encodeURIComponent(emailBody)}`;
                ...
                {submitStatus === 'success' && (
                  <div className="mb-6 p-4 bg-green-500/20 border border-green-500/30 rounded-lg flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-green-400 text-sm">Your email client should have opened with the message.</p>
                    </div>
                  </div>
                )}
